...
insert into contact (id, phone_number, email, line1, line2, city, state, postal_code, country)
values (10003, '+33e1928372892', 'susansamson@mail.com', 'High Street 33', '2nd Floor', 'New York City', 'New York', 'NYC123', 'United States');
...
insert into user (id, contact_id, username, password, first_name, last_name)
values (20002, 10002, 'rajan', '123', 'rajan', 'perumal');
...
insert into product_line (id, name, category, brand, price)
values (30003, 'FloatZig 1 Sneakers', 'MENS_SHOES', 'Reebok', 200.99);

insert into product_line (id, name, category, brand, price)
values (30004, 'Hyper Runners 500', 'WOMENS_SHOES', 'Asics', 99.99);

insert into product_line (id, name, category, brand, price)
values (30005, 'Comfy Walkers EZ', 'WOMENS_SHOES', 'Uggs', 79.99);

insert into product_line (id, name, category, brand, price)
values (30006, 'Revolution Trainers', 'WOMENS_SHOES', 'Nikw', 69.99);
